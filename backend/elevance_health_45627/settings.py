"""
Django settings for elevance_health_45627 project.
...
ROOT_URLCONF = 'elevance_health_45627.urls'
...
WSGI_APPLICATION = 'elevance_health_45627.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "elevance_health_45627 API",
    "DESCRIPTION": "API documentation for elevance_health_45627 App",
    "VERSION": "v1",
}
